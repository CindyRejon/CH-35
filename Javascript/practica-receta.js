...
//nutella = Number (nutella); buleano
...
//Función para verificar si hay leche
...
function verificarIngredientes() {
  let harina = preguntarAlUsuario("Harina");
  let leche = preguntarAlUsuario("Leche");
  let mantequilla = preguntarAlUsuario("Mantequilla");
  let vainilla = preguntarAlUsuario("Vainilla");
  let huevo = preguntarAlUsuario("Huevo");
...
function prepararHotcakes() {
  if (verificarIngredientes()) {
    ...
    return ("¡Hotcakes listos para servir");
