...
Sintaxis es
 ...
 { 
    Codigo a ejecutar en cada interación del bluce
 }
 1.Inicialización: Se debe inicializar con una variable que será
 evaluada en la expresión a comparar.
 2.Condicion: es una expresión que debe cumplir la variable inicial (True), 
 sino se cumple (false) el blucle termina.
 3. Pasos a realizar: son los intervalos que cambiarán la variable
 inicial mientras está sea true.
...
Debemos usar indices del arreglo para poder usar el bucle, en indices 
desde el 0 hasta cualquier cantidad y usaremos la propiedad length 
*/
...
"Mandarinas", "Uvas"];
for (let fruta of frutas)//fruta hace referencia a cada elemento de frutas */
{
...
let suma = 0;
for (let i = 1; i <= 20; i ++) /*ejemplo de logica 1+2+3+4+5+6+7+....
+20  // i da inicio al indice, el siguiente num puede ser 0,1, o negativo*/
{suma += i;}
   console.log(suma);
...
/*Ciclo while
* Recorrer un bloque de código siempre que una condición especifica
sea verdadera
