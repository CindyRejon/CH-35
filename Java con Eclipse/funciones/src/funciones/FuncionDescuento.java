...
*/
/*La refactorizacion es reestructurar código que ya existe sin alterar su comportamiento. 
 * Tiene como objetivo mejorar la legibilidad, mantenibilidad y optimizacion de nuestro codigo*/
 ...
 public class FuncionDescuento {
		...
		public static void main(String[] args) {
			...
			double porcentaje = 15;// obtener el porcentaje de descuento
			double descuento = calcularDescuento(precioProducto, porcentaje);

			double porcentaje= 3;// obtener el impuesto
			double impuesto = calcularDescuento(precioProducto, porcentaje);
